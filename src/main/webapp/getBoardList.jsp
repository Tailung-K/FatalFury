    ...
    if (jsonObj.length > 0) {
        ...
        for (var nRow = 0, nTotCnt = jsonObj.length; nRow < nTotCnt; nRow++) {
            ...
            if (result.rank == null || result.rank == "" || result.rank == undefined || result.rank == "undefined") {
                sStx += "            <option value=''></option>\n";
            }
            
            if (result.rank == "01") {          
                sStx += "            <option value='01'>대리</option>\n";
            }
            
            
            if (result.rank == "02") {            
                sStx += "            <option value='02'>과장</option>\n";
            }
            
            if (result.rank == "03") {            
                sStx += "            <option value='03'>차장</option>\n";
            }
            
            if (result.rank == "04") {            
                sStx += "            <option value='04'>부장</option>\n";
            }
            
            if (result.rank == "05") {
                sStx += "            <option value='05'>이사</option>\n";                
            }
